...
keywordHandler:addSpellKeyword({ "water", "wave" }, {
	npcHandler = npcHandler,
...
keywordHandler:addKeyword({ "attack", "spells" }, StdModule.say, {
	npcHandler = npcHandler,
	text = { "In this category I have '{Whirlwind Throw}', '{Groundshaker}', '{Berserk}' and '{Fierce Berserk}' as well as ...", "'{Brutal Strike}', '{Front Sweep}', '{Inflict Wound}', '{Water Wave}' and '{Annihilation}'" },
})
